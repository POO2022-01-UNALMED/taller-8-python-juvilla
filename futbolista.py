...
class Futbolista(Deportista):
    _listaFutbolistas=[]
    def __init__(self,nombre,edad,altura,sexo,añosPracticando,golesMarcados,piernaHabil,tarjetasRojas):
        super().__init__(self,nombre,edad,altura,sexo,"Futbol",añosPracticando)
